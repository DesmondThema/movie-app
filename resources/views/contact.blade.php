        ...
        <div class="text-center">
            <div class="p-6">
                ...
                <p class="pt-2 text-lg font-semibold">
                    Kgothatso Desmond Thema
                </p>
                <p class="text-sm text-gray-600">
                    desmondthedev@gmail.com
                </p>
            </div>
            <div class="container mx-auto flex flex-col sm:flex-row items-end justify-between py-8">
                <ul class="flex items-center space-x-8">
                    <li>
                        <a href="mailto:me@example.com" class="text-indigo-500 hover:text-gray-400">
                    ...
                    <li>
                        <a href="https://youtube.com/drehimself" target="_blank" class="text-indigo-500 hover:text-gray-400">
                    ...
                    <li>
                        <a href="https://github.com/drehimself/gridsome-portfolio-starter" target="_blank" class="text-indigo-500 hover:text-gray-400">
                    ...
                    <li>
                        <a href="https://twitter.com/drehimself" target="_blank" class="text-indigo-500 hover:text-gray-400">
                    ...
                    <li>
                        <a href="https://instagram.com" target="_blank" class="text-indigo-500 hover:text-gray-400">
